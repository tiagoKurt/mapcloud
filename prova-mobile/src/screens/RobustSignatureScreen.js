  ...
  const panResponder = useRef(
    PanResponder.create({
      ...
      onPanResponderGrant: (evt) => {
        ...
        setSignaturePoints([{ x: locationX, y: locationY, id: Date.now() }]);
      },
      onPanResponderMove: (evt) => {
        if (isDrawing) {
          const { locationX, locationY } = evt.nativeEvent;
          setSignaturePoints(prev => [...prev, { 
            x: locationX, 
            y: locationY, 
  ...
  return (
    <View style={styles.container}>
          ...
          {!hasSignature && !isDrawing && (
            <View style={styles.placeholderContainer}>
              ...
              <Text style={styles.placeholderSubtext}>
                Você verá pontos aparecendo conforme desenha
              </Text>
            </View>
          )}
      ...
      <View style={styles.instructions}>
        ...
        <Text style={styles.instructionText}>
          • Você verá pontos pretos aparecendo conforme desenha
        </Text>
        <Text style={styles.instructionText}>
...
export default RobustSignatureScreen;
