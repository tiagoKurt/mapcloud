...
const SimpleSignatureScreen = () => {
  ...
  const saveSignature = async () => {
    ...
    try {
      ...
      const signatureData = signaturePoints.map(point => `${point.x},${point.y}`).join(';');
    ...
    <View style={styles.container}>
      ...
      <View style={styles.signatureContainer}>
        <View style={styles.signatureBox} {...panResponder.panHandlers}>
          ...
          {}
          {signaturePoints.length === 0 && !isDrawing && (
...
export default SimpleSignatureScreen;
